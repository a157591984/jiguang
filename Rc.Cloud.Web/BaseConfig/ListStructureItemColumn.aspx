<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListStructureItemColumn.aspx.cs" Inherits="Rc.Cloud.Web.BaseConfig.ListStructureItemColumn" %>
        ...
        <div>
            <div class="div_search_pop">
                <table cellpadding="0" cellspacing="0" class="table_content">
                    <tr>
                        <td class="td_content_001" width="30%">字段名称</font>:</td>
                        <td class="td_content_002" width="70%">
                            <asp:TextBox ID="tableColumn" Enabled="false" runat="server" IsRequired="true" MaxLength="100" CssClass="txt"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td class="td_content_001" width="30%">字段备注<font color="red">*</font>:</td>
                        <td class="td_content_002" width="70%">
                            <asp:TextBox ID="tablecolumninfo" runat="server" IsRequired="true" MaxLength="100" CssClass="txt"></asp:TextBox></td>
                    </tr>
                </table>
            </div>
            <div class="div_page_bottom_operation">
                <asp:Button ID="btnSave" runat="server" CssClass="btn" Text="保 存" OnClick="btnSave_Click" OnClientClick="return btnClientSave_Click()" />
