...
namespace Rc.Cloud.Web.BaseConfig
{
    public partial class UserControlConfig : Rc.Cloud.Web.Common.InitPage
    {
        ...
        protected string GetHtmlData()
        {
            ...
            strHtmlData.Append("<td style='width:10%;'>标识</td>");
            strHtmlData.Append("<td style='width:15%;'>名称</td>");
            strHtmlData.Append("<td style='width:20%;'>说明</td>");
            ...
            for (int j = 0; j < dt.Rows.Count; j++)
            {
                ...
                strHtmlData.AppendFormat("&nbsp;&nbsp;<a href='javascript:void(0)' onclick=\"showPopAddOrEdit('{0}');\" />修改</a>",Rc.Common.StrUtility.clsUtility.Encrypt(dt.Rows[j]["DictionarySQlMaintenance_ID"].ToString()));
