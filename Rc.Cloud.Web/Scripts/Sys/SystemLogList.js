...
function showInfo(id, handel, sysUser_Name) {
    var page = "SystemLogListView.aspx?id=" + id + "&sysUser_Name=" + sysUser_Name;
    if (handel == "1") {//添加
    ...
    $("#divIfram").html("<iframe id='iframDrugFiled' frameborder='0' width='100%' style='margin: 0px' src='" + page + "'  height='470px'></iframe>");
    $("#div_Pop").show();
