<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DownloadTchTestpaperFiles.aspx.cs" Inherits="Rc.Cloud.Web.ReCloudMgr.DownloadTchTestpaperFiles" %>
    ...
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            var loadData = function () {
                ...
                $.ajaxWebService("DownloadTchTestpaperFiles.aspx/GetDataList", JSON.stringify(dto), function (data) {
