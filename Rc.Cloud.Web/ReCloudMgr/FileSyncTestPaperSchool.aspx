<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileSyncTestPaperSchool.aspx.cs" Inherits="Rc.Cloud.Web.ReCloudMgr.FileSyncTestPaperSchool" %>
...
<body class="bg_white">
    <form id="form1" runat="server">
        ...
        <div class="form-inline search_bar mb">
            ...
            <input type="button" class="btn btn-primary btn-sm" value="同步预览" onclick="javascript: window.open('FileSyncViewList.aspx?FileSyncExecRecord_Type=同步试卷<%=SchoolId%>    ');" />
        ...
        <script type="text/javascript">
            var loadData = function () {
                ...
                $.ajaxWebService("FileSyncTestPaperSchool.aspx/GetDataList", JSON.stringify(dto), function (data) {
