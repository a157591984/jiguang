<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/sys.Master" AutoEventWireup="true" CodeBehind="Res_Doc.aspx.cs" Inherits="Rc.Cloud.Web.ReCloudMgr.Res_Doc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        ...
        <td>{$T.record.textbookversion}</td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSContent" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        var loadData = function () {
            ...
            $.ajaxWebService("Res_Doc.aspx/GetStatRes_Doc", JSON.stringify(dto), function (data) {
