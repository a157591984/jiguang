<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DownloadTchPlanFiles.aspx.cs" Inherits="Rc.Cloud.Web.ReCloudMgr.DownloadTchPlanFiles" %>
    ...
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            var loadData = function () {
                ...
                $.ajaxWebService("DownloadTchPlanFiles.aspx/GetDataList", JSON.stringify(dto), function (data) {
