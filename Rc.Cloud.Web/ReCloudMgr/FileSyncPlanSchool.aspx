<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileSyncPlanSchool.aspx.cs" Inherits="Rc.Cloud.Web.ReCloudMgr.FileSyncPlanSchool" %>
...
<body class="bg_white">
    <form id="form1" runat="server">
        ...
        <div class="form-inline search_bar mb">
            ...
            <input type="button" class="btn btn-primary btn-sm" value="同步预览" onclick="javascript: window.open('FileSyncViewList.aspx?FileSyncExecRecord_Type=同步教案<%=SchoolId%>    ');" />
        ...
        <script type="text/javascript">
            var loadData = function () {
                ...
                $.ajaxWebService("FileSyncPlanSchool.aspx/GetDataList", JSON.stringify(dto), function (data) {
