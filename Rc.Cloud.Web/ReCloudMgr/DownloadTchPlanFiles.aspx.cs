...
{
    public partial class DownloadTchPlanFiles : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            strSql = "select top 1 FileSyncExecRecord_TimeStart from FileSyncExecRecord where FileSyncExecRecord_Status ='0' and FileSyncExecRecord_Type='同步老师自有教案" + SchoolId + "' order by FileSyncExecRecord_TimeStart desc";
...
{4} order by t1.Createtime desc"
        ...
        public static string GetDataList(string SchoolId, string strFileSyncExecRecord_Status, int PageSize, int PageIndex)
        {
            try
            {
                ...
                strWhere += " and f.FileSyncExecRecord_Type='同步老师自有教案" + SchoolId + "' ";
