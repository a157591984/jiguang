<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadFile.aspx.cs" Inherits="Rc.Web.ReCloudMgr.UploadFile" %>
    ...
    <script type="text/javascript">
        $(function () {
            $("#file_upload").uploadify({
                ...
                'multi': true,
                'fileTypeDesc': '支持的格式：',
                'fileTypeExts': '*.class;*.dsc;*.xpt;*.doc;*.docx;*.xls;*.xlsx;*.rar;',
                'fileSizeLimit': '150MB',
                'removeTimeout': 1,
                'fileDataName ': 'a',
                //返回一个错误，选择文件的时候触发
