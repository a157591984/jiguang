<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SyncTobe_LogList.aspx.cs" Inherits="Rc.Cloud.Web.ReCloudMgr.SyncTobe_LogList" %>
    ...
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            var loadData = function () {
                var dto = {
                    strFileSyncExecRecord_Type: "<%=FileSyncExecRecord_Type%>",
                ...
                $.ajaxWebService("SyncTobe_LogList.aspx/GetDataList", JSON.stringify(dto), function (data) {
