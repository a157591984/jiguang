<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/sys.Master" AutoEventWireup="true" CodeBehind="StatsMember.aspx.cs" Inherits="Rc.Cloud.Web.ReCloudMgr.StatsMember" %>
            ...
            <div class="panel-body">
                <div class="panel panel-default mfilter" data-name="mfilter">
                    <div class="mfilter_control" data-name="mfilterControl">
                        <div class="mfilter_header" data-name="mfilterHeader">角色</div>
                        <div class="mfilter_body" data-name="mfilterBody">
                            <div class="mfilter_item" data-name="mfilterItem" ajax-name="MemberType">
                                <a href="javascript:;" ajax-value="A" class="active">全部</a>
                                <a href="javascript:;" ajax-value="T">老师</a>
                                <a href="javascript:;" ajax-value="S">学生</a>
                            </div>
                        </div>
                    </div>
                    <div class="mfilter_control" data-name="mfilterControl">
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSContent" runat="server">
    <script type="text/javascript">
        ...
        var loadData = function () {
            var dto = {
                MemberType: $('[ajax-name="MemberType"]').find('a.active').attr('ajax-value'),
                DateType: $('[ajax-name="DateType"]').find('a.active').attr('ajax-value'),
                SchoolId: $('[ajax-name="SchoolId"]').find('a.active').attr('ajax-value'),
                datetime: $('.active[ajax-name="DateTime"]').find('a.active').attr('ajax-value'),
                x: Math.random()
            };
            $.ajaxWebService("StatsMember.aspx/GetData", JSON.stringify(dto), function (data) {
