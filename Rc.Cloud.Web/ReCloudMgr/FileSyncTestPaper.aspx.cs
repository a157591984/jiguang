...
{
    public partial class FileSyncTestPaper : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            strSql = "select top 1 FileSyncExecRecord_TimeStart from FileSyncExecRecord where FileSyncExecRecord_Status = '0' and FileSyncExecRecord_Type='同步试卷' order by FileSyncExecRecord_TimeStart desc";
...
where FileSyncExecRecord_Type='同步试卷' and FileSyncExecRecord_Status='0' and DateDiff(MI,FileSyncExecRecord_TimeStart,getdate())>120 ";
        ...
        private DataTable GetDtFileTestPaperTestQuestion()
        {
            ...
            strSql = string.Format(@"select t1.Book_Id,Resource_Type, ParticularYear,GradeTerm,Resource_Version,Subject,t1.ResourceToResourceFolder_id
...
and ba.AuditState='1'
{1}
order by t2.Createtime desc", Resource_TypeConst.testPaper类型文件, strSqlTemp);
...
order by t2.Createtime desc", Resource_TypeConst.testPaper类型文件, strSqlTemp);
        ...
        public static string GetDataList(string strFileSyncExecRecord_Status, int PageSize, int PageIndex)
        {
            try
            {
                ...
                strWhere += " and f.FileSyncExecRecord_Type='同步试卷' ";
