<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelationTQ.aspx.cs" Inherits="Rc.Cloud.Web.ReCloudMgr.RelationTQ" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
            ...
            $("#btnRelation").click(function () {
                ...
                if ($("#hidChecked").val() == "" || $("#hidChecked").val() == undefined) {
                    ...
                    var index = layer.confirm('确定要关联选中的试卷么吗？', { icon: 4, title: '提示' }, function () {
                        ...
                        var dto = {
                            TestPaper_Frame_Id: TestPaper_Frame_Id,
                            TestPaper_FrameDetail_Id: "<%=TestPaper_FrameDetail_Id%>",
                            TestPaper: $("#hidChecked").val(),
                            x: Math.random()
                        };
                        $.ajaxWebService("RelationTQ.aspx/GetRelationPaper", JSON.stringify(dto), function (data) {
                            if (data.d == "1") {
            ...
            $("#btnCancel").click(function () {
                ...
                if ($("#hidChecked").val() == "" || $("#hidChecked").val() == undefined) {
                    ...
                    var index = layer.confirm('确定要取消关联选中的试卷么吗？', { icon: 4, title: '提示' }, function () {
                        ...
                        $.ajaxWebService("RelationTQ.aspx/CancelRelationPaper", JSON.stringify(dto), function (data) {
                            if (data.d == "1") {
        ...
        var loadData = function (type) {
            ...
            $.ajaxWebService("RelationTQ.aspx/GetTree", JSON.stringify(dto), function (data) {
                if (data.d != "") {
                    $("#ReTree").html(data.d);
                }
