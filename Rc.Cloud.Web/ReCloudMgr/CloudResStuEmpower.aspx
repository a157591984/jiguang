<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/sys.Master" AutoEventWireup="true" CodeBehind="CloudResStuEmpower.aspx.cs" Inherits="Rc.Cloud.Web.ReCloudMgr.CloudResStuEmpower" %>
        ...
        <div class="panel">
            <div class="panel-body">
                <div class="form-inline search_bar mb">
                    ...
                    <input type="text" id="txtTchName" class="form-control input-sm" placeholder="班主任/代课老师" clientidmode="Static">
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSContent" runat="server">
    ...
    <script type="text/javascript">
        var loadData = function () {
            ...
            $.ajaxWebService("CloudResStuEmpower.aspx/GetUserList", JSON.stringify(dto), function (data) {
