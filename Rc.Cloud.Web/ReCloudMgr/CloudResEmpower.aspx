<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/sys.Master" AutoEventWireup="true" CodeBehind="CloudResEmpower.aspx.cs" Inherits="Rc.Cloud.Web.ReCloudMgr.CloudResEmpower" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSContent" runat="server">
    <script type="text/javascript">
        ...
        var loadData = function () {
            ...
            $.ajaxWebService("CloudResEmpower.aspx/GetCloudBooks", JSON.stringify(dto), function (data) {
