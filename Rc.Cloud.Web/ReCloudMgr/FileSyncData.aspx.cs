...
{
    public partial class FileSyncData : Rc.Cloud.Web.Common.InitPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string strSql = string.Empty;
            strSql = "select top 1 FileSyncExecRecord_TimeStart from FileSyncExecRecord where FileSyncExecRecord_Status = '0' and FileSyncExecRecord_Type='同步数据' order by FileSyncExecRecord_TimeStart desc";
        ...
        //    model_FileSyncExecRecord.FileSyncExecRecord_Type = "同步数据";
        ...
        //    model_FileSyncExecRecord.createUser = loginUser.SysUser_ID;
        //    try
        //    {

        //        //记录同步之前的信息
        //        bll_FileSyncExecRecord.Add(model_FileSyncExecRecord);
        //        int result = Rc.Common.DBUtility.DbHelperSQL.ExecuteSqlByTime("EXEC P_SynchronousData_new '" + strFileSyncExecRecord_id + "'", 7200);
        ...
        public static string GetDataList(string strFileSyncExecRecord_Status, int PageSize, int PageIndex)
        {
            try
            {
                ...
                strWhere += " and f.FileSyncExecRecord_Type='同步数据' ";
