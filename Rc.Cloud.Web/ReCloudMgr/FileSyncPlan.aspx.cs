...
{
    public partial class FileSyncPlan : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            strSql = "select top 1 FileSyncExecRecord_TimeStart from FileSyncExecRecord where FileSyncExecRecord_Status = '0' and FileSyncExecRecord_Type='同步教案' order by FileSyncExecRecord_TimeStart desc";
...
where FileSyncExecRecord_Type='同步教案' and FileSyncExecRecord_Status='0' and DateDiff(MI,FileSyncExecRecord_TimeStart,getdate())>120 ";
...
order by t2.Createtime desc", Resource_TypeConst.ScienceWord类型文件, Resource_TypeConst.class类型文件, Resource_TypeConst.class类型微课件, strSqlTemp);
        ...
        public static string GetDataList(string strFileSyncExecRecord_Status, int PageSize, int PageIndex)
        {
            try
            {
                ...
                strWhere += " and f.FileSyncExecRecord_Type='同步教案' ";
