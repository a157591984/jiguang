<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestPaper_FrameView.aspx.cs" Inherits="Rc.Cloud.Web.ReCloudMgr.TestPaper_FrameView" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var loadData = function () {
            ...
            $.ajaxWebService("TestPaper_FrameView.aspx/GetSxxmbList", JSON.stringify(dto), function (data) {
