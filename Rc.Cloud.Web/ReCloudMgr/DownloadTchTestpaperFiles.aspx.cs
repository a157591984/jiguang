...
{
    public partial class DownloadTchTestpaperFiles : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            strSql = "select top 1 FileSyncExecRecord_TimeStart from FileSyncExecRecord where FileSyncExecRecord_Status ='0' and FileSyncExecRecord_Type='同步老师自有习题集" + SchoolId + "' order by FileSyncExecRecord_TimeStart desc";
        ...
        public void ResSynchroFile()
        {
            ...
            model_FileSyncExecRecord.FileSyncExecRecord_Type = "同步老师自有习题集" + SchoolId;
...
{2} order by t1.Createtime desc", Resource_TypeConst.testPaper类型文件, Resource_ClassConst.自有资源, strWhere);
        ...
        public static string GetDataList(string SchoolId, string strFileSyncExecRecord_Status, int PageSize, int PageIndex)
        {
            try
            {
                ...
                strWhere += " and f.FileSyncExecRecord_Type='同步老师自有习题集" + SchoolId + "' ";
