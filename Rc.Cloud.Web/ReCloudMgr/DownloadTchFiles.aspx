<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DownloadTchFiles.aspx.cs" Inherits="Rc.Cloud.Web.ReCloudMgr.DownloadTchFiles" %>
...
<head runat="server">
    ...
    <title>局域网解决方案-下载老师自有文件到学校服务器（处理历史数据问题）</title>
    ...
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            var loadData = function () {
                ...
                $.ajaxWebService("DownloadTchFiles.aspx/GetDataList", JSON.stringify(dto), function (data) {
