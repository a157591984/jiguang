<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SyncFileSchool_Tobe.aspx.cs" Inherits="Rc.Cloud.Web.ReCloudMgr.SyncFileSchool_Tobe" %>
...
<body class="bg_white">
    <form id="form1" runat="server">
        <div class="form-inline search_bar mb">
            <asp:Button ID="btnSchool" runat="server" CssClass="btn btn-primary btn-sm" Text="执行资源同步" OnClick="btnTestpaper_Click" />
            ...
            {#foreach $T.list as record}
                <tr>
                    ...
                    <td class="opera">
                        ...
                        <a href="SyncFileSchool_Tobe.aspx?SchoolId=<%=SchoolId %>&SysUser_ID=<%=SysUser_ID %>&bookId={$T.record.bookId}">资源明细</a>
                        {#/if}
                        {#if $T.record.IsCanExecing=='1'}
                        <a href="javascript:;" data-name="sync_school" data-bookid="{$T.record.bookId}" data-rtrfid="{$T.record.rtrfId}" data-rtype="{$T.record.Resource_Type}">执行同步</a>
                        {#/if}
        ...
        <script type="text/javascript">
            var loadData = function () {
                ...
                $.ajaxWebService("SyncFileSchool_Tobe.aspx/GetDataList", JSON.stringify(dto), function (data) {
