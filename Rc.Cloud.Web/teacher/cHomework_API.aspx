<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cHomework_API.aspx.cs" Inherits="Rc.Cloud.Web.teacher.cHomework_API" %>
    ...
    <form id="form1" runat="server">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            <li><a href="cHomework_API.aspx?ugid=<%=strUserGroup_IdActivity %>" class="active">习题集</a></li>
        ...
        <script type="text/javascript">
            ...
            function Show(Classid, rom) {
                ...
                window.location.href = "cHomework_API.aspx?" + Classid + "&" + rom + "&strResourceForder_IdDefault=" + id;
            }
            ...
            var loadData = function () {
                ...
                $.ajaxWebService("cHomework_API.aspx/GetcHomework", JSON.stringify(dto), function (data) {
