<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/teacher.Master" AutoEventWireup="true" CodeBehind="teachingPlan.aspx.cs" Inherits="Rc.Cloud.Web.teacher.teachingPlan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="iframe-subnav">
        <ul class="subnav">
            <li><a href="teachingPlan.aspx" class="active">已购买教案</a></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSContent" runat="server">
    <script type="text/javascript">
        var loadData = function () {
            ...
            $.ajaxWebService("teachingPlan.aspx/GetResourceFolderListPage", JSON.stringify(dto), function (data) {
