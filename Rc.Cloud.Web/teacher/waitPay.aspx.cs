...
{
    public partial class waitPay : Rc.Cloud.Web.Common.FInitData
    {
        ...
        public static string GetOrderList(string userid, int PageIndex, int PageSize)
        {
            try
            {
                ...
                string strWhere = " (UserOrder_Status=" + Convert.ToInt32(UOrderStatus.待付款) + " or UserOrder_Status=" + Convert.ToInt32(UOrderStatus.已取消) + ")";
