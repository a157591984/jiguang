<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/teacher.Master" AutoEventWireup="true" CodeBehind="GradeVerifyNotice.aspx.cs" Inherits="Rc.Cloud.Web.teacher.GradeVerifyNotice" %>
    ...
    <div class="iframe-container">
                        ...
                        <ItemTemplate>
                            <li>
                                <div class="mtree_link mtree-link-hook <%#GetStyle(Eval("UserGroup_Id").ToString()) %>"
                                    data-url="GradeVerifyNotice.aspx?ugroupId=<%#Eval("UserGroup_Id") %>">
        ...
        <div class="iframe-main pa">
            <ul class="nav nav-tabs mb">
                ...
                <li class="active"><a href="GradeVerifyNotice.aspx?ugroupId=<%=ugroupId %>">消息</a></li>
            </ul>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSContent" runat="server">
    <script type="text/javascript">
        ...
        var loadData = function () {
            ...
            $.ajaxWebService("GradeVerifyNotice.aspx/GetClassNotice", JSON.stringify(dto), function (data) {
        ...
        var auditApplyData = function (tp, ugmId) {
            ...
            layer.confirm(_msg, {
                ...
                $.ajaxWebService("GradeVerifyNotice.aspx/AuditApplyData", JSON.stringify(dto), function (data) {
                    if (data.d == "1") {
