<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrepareLessons_view.aspx.cs" Inherits="Rc.Cloud.Web.teacher.PrepareLessons_view" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#btnSave").click(function () {
                ...
                if ($('#tb1').find('td').length == 1) {
                    layer.msg("请选择负责人", { time: 2000, icon: 2 });
                    return false;
                }
            })
            //选择联系人
        ...
        var loadData = function () {
            ...
            $.ajaxWebService("PrepareLessons_view.aspx/GetList", JSON.stringify(dto), function (data) {
                ...
                if (json.err == "null") {
                    ...
                    $("#tb1").html("<tr><td colspan='100' align='center'>暂无负责人请选择</td></tr>");
                }
            }, function () { });
        }
...
<body>
    <form id="form1" runat="server">
        <div class="container pa prepare_lessons_container">
            <h4 class="page_title">发起备课</h4>
            <div class="row">
                <div class="col-xs-4">
            ...
            <div class="form-group">
                ...
                <div>
                    <%--<p>
                        <button type="button" id="btnSelect" class="btn-link person-charge-hook"><i class="fa fa-plus-circle"></i>&nbsp;选择负责人</button>
                    </p>--%>
