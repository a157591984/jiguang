<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/teacher.Master" AutoEventWireup="true" CodeBehind="AllRankings.aspx.cs" Inherits="Rc.Cloud.Web.teacher.AllRankings" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="header_subnav">
        <ul>
            ...
            <li><a href="AllRankings.aspx" class="active">各科排名</a></li>
            <li><a href="University.aspx">综合排名</a></li>
        </ul>
    </div>
    <!-- 内容 -->
    <div class="main_box">
