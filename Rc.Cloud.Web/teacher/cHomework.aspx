<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/teacher.Master" AutoEventWireup="true" CodeBehind="cHomework.aspx.cs" Inherits="Homework.teacher.cHomework" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="iframe-subnav">
        <ul class="subnav">
            <li><a href="cHomework.aspx?ugid=<%=strUserGroup_IdActivity %>" class="active">习题集</a></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSContent" runat="server">
    <script type="text/javascript">
        $(function () {
            ...
            $('.mtree-class-hook').mtree({
                onClick: function (obj) {
                    ...
                    window.location.href = "cHomework.aspx?" + ugid + "&strResourceForder_IdDefault=" + id;
                }
            });
        ...
        function loadData() {
            ...
            $.ajaxWebService("cHomework.aspx/GetcHomework", JSON.stringify(dto), function (data) {
