<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/teacher.Master" AutoEventWireup="true" CodeBehind="waitRate.aspx.cs" Inherits="Rc.Cloud.Web.teacher.waitRate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="order_panel">
                        <div class="panel_heading">
                            ...
                            <ul class="panel_control">
                                <li><a href="allOrder.aspx">全部订单</a></li>
                                <li><a href="waitPay.aspx">待付款</a></li>
                                <li class="active"><a href="waitRate.aspx">已评价</a></li>
                            </ul>
                        </div>
                        <div class="panel_body">
    ...
    {#foreach $T.list as record}
        <tr>
            <td><a href="/teacher/TeachingplanShow.aspx?ResourceFolder_ID={$T.record.Book_Id}" target="_blank">{$T.record.BookName}</a></td>
            ...
            <td>
                {#if $T.record.Status==3}
                    {#if $T.record.CommentCount>0}
                   <a href="/teacher/TeachingplanShow.aspx?ResourceFolder_ID={$T.record.Book_Id}" target="_blank">已评价</a>
                    {#else}
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSContent" runat="server">
    <script type="text/javascript">
        ...
        function loadData() {
            ...
            $.ajaxWebService("waitRate.aspx/GetOrderList", JSON.stringify(dto), function (data) {
