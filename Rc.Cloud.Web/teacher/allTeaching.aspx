<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/teacher.Master" AutoEventWireup="true" CodeBehind="allTeaching.aspx.cs" Inherits="Rc.Cloud.Web.teacher.allTeaching" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSContent" runat="server">
    <script type="text/javascript">
        ...
        var LoadCity = function (pid) {
            $.ajaxWebService("allTeaching.aspx/GetAreaCityInfo", "{pid:'" + pid + "',x:'" + Math.random() + "'}", function (data) { $("#ddlCity").html(data.d); }, function () { $("#ddlCity").html("<option value=\"-1\">市区</option>"); }, false);
        }
    </script>
