<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/teacher.Master" AutoEventWireup="true" CodeBehind="waitPay.aspx.cs" Inherits="Rc.Cloud.Web.teacher.waitPay" %>
                    ...
                    <div class="order_panel">
                        <div class="panel_heading">
                            ...
                            <ul class="panel_control">
                                ...
                                <li class="active"><a href="waitPay.aspx">待付款</a></li>
    ...
    {#foreach $T.list as record}
        <tr>
            ...
            <td>
                ...
                <a href="payment.aspx?orderType=1&rid={$T.record.Book_Id}">立即付款</a>
                <a href="##" onclick="CancelOrder('{$T.record.UserOrder_Id}')">取消订单</a>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSContent" runat="server">
    <script type="text/javascript">
        ...
        var loadData = function () {
            ...
            $.ajaxWebService("waitPay.aspx/GetOrderList", JSON.stringify(dto), function (data) {
