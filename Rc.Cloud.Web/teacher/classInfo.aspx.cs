    ...
    public partial class classInfo : Rc.Cloud.Web.Common.FInitData
    {
        ...
        protected void ButtonOK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ClientScript.RegisterStartupScript(this.GetType(), "save", "<script type='text/javascript'>layer.msg('班级名称存在敏感词汇，请重新填写。',{icon:2,time:2000});</script>");
                    return;
                }
                else
                {
                ...
                {
                    ClientScript.RegisterStartupScript(this.GetType(), "save", "<script type='text/javascript'>layer.msg('班级简介存在敏感词汇，请重新填写。',{icon:2,time:2000});</script>");
                    return;
                }
                else
                {
            ...
            {
                ClientScript.RegisterStartupScript(this.GetType(), "Save", "<script type='text/javascript'> Handel('2','" + ex.Message + "')</script>");
            }
        }
