<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/teacher.Master" AutoEventWireup="true" CodeBehind="pHomework.aspx.cs" Inherits="Homework.teacher.pHomework" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="iframe-subnav">
        <ul class="subnav">
            ...
            <li id="apHomework" runat="server" visible="false"><a href="pHomework.aspx?ugid=<%=strUserGroup_IdActivity %>" class="active">集体备课习题集</a></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSContent" runat="server">
    <script type="text/javascript">
        $(function () {
            ...
            $('.mtree-class-hook').mtree({
                onClick: function (obj) {
                    ...
                    var id = $('.mtree-homework-hook .mtree-link-hook.active').data('id');
                    window.location.href = "pHomework.aspx?" + ugid + "&strResourceForder_IdDefault=" + id;
                }
            });
            $('.mtree-homework-hook').mtree({
                ...
                onLoad: function (obj) {
                    obj.find('.mtree-link-hook.active').click();
                }
            });
        ...
        //    window.location.href = "pHomework.aspx?" + Classid + "&" + rom + "&strResourceForder_IdDefault=" + id;
        //}
        ...
        function loadData() {
            ...
            $.ajaxWebService("pHomework.aspx/GetcHomework", JSON.stringify(dto), function (data) {
