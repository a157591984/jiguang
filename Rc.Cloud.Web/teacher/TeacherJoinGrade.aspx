<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherJoinGrade.aspx.cs" Inherits="Rc.Cloud.Web.teacher.TeacherJoinGrade" %>
        ...
        $(function () {
            ...
            $("#btnSubmit").click(function () {
                if ($.trim($("#txtUserGroup_Id").val()) == "") {
                    layer.msg("年级号不能为空", { time: 1000, icon: 4 });
                    return false;
                }
                if ($.trim($("#txtUser_ApplicationReason").val()) == "") {
                    layer.msg("验证消息不能为空", { time: 1000, icon: 4 });
                    return false;
                }
            });
        });
