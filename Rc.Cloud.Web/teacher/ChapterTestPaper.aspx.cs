...
{
    public partial class ChapterTestPaper : Rc.Cloud.Web.Common.FInitData
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string strResource_Type = Resource_TypeConst.章节组卷.ToString();
        ...
        private StringBuilder GetTestForderHtml(string strUserGroup_IdActivity, string strTestForder_IdActivity, DataTable dtTestForder)
        {
            ...
            strTempHtml.Append("<div class='page_title pv'>目录</div>");
