<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/teacher.Master" AutoEventWireup="true" CodeBehind="mHomework.aspx.cs" Inherits="Homework.teacher.mHomework" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="iframe-subnav">
        <ul class="subnav">
            ...
            <li><a href="mHomework.aspx?ugid=<%=strUserGroup_IdActivity %>" class="active">自有习题集</a></li>
        ...
        $(function () {
            ...
            $('.mtree-class-hook').mtree({
                onClick: function (obj) {
                    ...
                    window.location.href = "mHomework.aspx?" + ugid + "&strResourceForder_IdDefault=" + id;
                }
            });
