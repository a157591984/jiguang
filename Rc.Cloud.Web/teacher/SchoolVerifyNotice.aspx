<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/teacher.Master" AutoEventWireup="true" CodeBehind="SchoolVerifyNotice.aspx.cs" Inherits="Rc.Cloud.Web.teacher.SchoolVerifyNotice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="iframe-container">
                        ...
                        <ItemTemplate>
                            <li>
                                <div class="mtree_link mtree-link-hook <%#GetStyle(Eval("UserGroup_Id").ToString()) %>"
                                    data-url="SchoolVerifyNotice.aspx?ugroupId=<%#Eval("UserGroup_Id") %>">
        ...
        <div class="iframe-main pa">
            <ul class="nav nav-tabs mb">
                ...
                <li class="active"><a href="SchoolVerifyNotice.aspx?ugroupId=<%=ugroupId %>">消息</a></li>
            </ul>
    ...
    <tr>
        <td class="text-center"><label><input type="checkbox" name="id[]" value="{$T.record.UserGroup_Member_Id}" /></label></td>
        <td>{$T.record.PostName}</td>
        <td>{$T.record.UserGroup_Name}{#if $T.record.IType=='1'}({$T.record.UserGroup_Id}){#/if}</td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSContent" runat="server">
    <script type="text/javascript">
        ...
        var loadData = function () {
            ...
            $.ajaxWebService("SchoolVerifyNotice.aspx/GetClassNotice", JSON.stringify(dto), function (data) {
        ...
        var auditApplyData = function (tp, ugmId) {
            ...
            layer.confirm(_msg, {
                ...
                $.ajaxWebService("SchoolVerifyNotice.aspx/AuditApplyData", JSON.stringify(dto), function (data) {
                    if (data.d == "1") {
