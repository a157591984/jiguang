<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pHomework_API_Select.aspx.cs" Inherits="Rc.Cloud.Web.teacher.pHomework_API_Select" %>
    ...
    <form id="form1" runat="server">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            <li><a href="cHomework_API_Select.aspx">习题集</a></li>
                            <li><a href="mHomework_API_Select.aspx">自有习题集</a></li>
                            <li class="active"><a href="pHomework_API_Select.aspx">集体备课习题集</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        {#foreach $T.list as record}
            <tr>
                ...
                <td class="text-center">
                    <a href="HomeworkPreviewT.aspx?ResourceToResourceFolder_Id={$T.record.docId}&strResourceForder_IdDefault={$T.record.ResourceFolder_Id}&isBack=3">预览</a>
        ...
        <script type="text/javascript">
            ...
            var loadData = function () {
                ...
                $.ajaxWebService("pHomework_API_Select.aspx/GetcHomework", JSON.stringify(dto), function (data) {
