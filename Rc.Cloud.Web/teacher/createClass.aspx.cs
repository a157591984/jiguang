...
{
    public partial class CreateClass : Rc.Cloud.Web.Common.FInitData
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Rc.Cloud.Web.Common.pfunction.SetDdlStartSchoolYear(ddlStartSchoolYear, years - 5, years + 1, false, "-请选择-");
