<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/student.Master" AutoEventWireup="true" CodeBehind="payment.aspx.cs" Inherits="Rc.Cloud.Web.student.payment" %>
            ...
            $.get("../Payment/WxPayAPI/GetWxPayState.ashx", { rid: "<%=enOrderNo %>", x: new Date().getTime() },
                function (data) {
                    if (data == "success") {
                        clearInterval(funWXInterval);
                        layer.closeAll();
                        layer.msg("支付成功", { icon: 1, time: 2000 }, function () { window.location.href = "../student/allOrder.aspx"; })
                    }
                });
        }
