<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/student.Master" AutoEventWireup="true" CodeBehind="safeSetting.aspx.cs" Inherits="Homework.student.safeSetting" %>
        ...
        $(function () {
            $("#btnConfirm").click(function () {
                if ($.trim($("#txtOldPass").val()) == "") {
                    layer.msg("请输入原始密码", { icon: 2, time: 1000 });
                    return false;
                }
                ...
                if ($.trim($("#txtNewPass2").val()) == "") {
                    layer.msg("请输入重复密码", { icon: 2, time: 1000 });
                    return false;
                }
