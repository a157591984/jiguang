...
namespace Rc.Cloud.Web.student
{
    ...
    public partial class OHomeWorkViewTTNew : System.Web.UI.Page
    {
...
where hw.HomeWork_Id='{1}'"
                ...
                stbLink.AppendFormat("<li {3}><a href=\"OHomeWorkViewTTNew.aspx?ResourceToResourceFolder_Id={0}&HomeWork_Id={1}&StudentId={2}\">批改详情</a></li>"
