<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/student.Master" AutoEventWireup="true" CodeBehind="message.aspx.cs" Inherits="Rc.Cloud.Web.student.message" %>
    ...
    <div class="iframe-container">
        <div class="container pt">
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th width="35">
                            <label>
                                <input type="checkbox" data-name="CheckAll" data-mark="id" /></label></th>
                        <th>发送人</th>
                        <th>消息内容</th>
                        <th>发送时间</th>
                        <th>状态</th>
            ...
            <div class="pagination_container">
                <button type="button" class="btn btn-primary pull-left mt" style="display: none;" data-name="batchMark">批量标记</button>
                <ul class="pagination">
                </ul>
            </div>
        </div>
