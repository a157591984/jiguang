            ...
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    listReturn.Add(new
                    {
                        ...
                        Status = dt.Rows[i]["UserOrder_Status"],
                        UserOrder_Status = temp,//string.IsNullOrEmpty(dt.Rows[i]["UserOrder_Status"].ToString()) ? "已授权" : Rc.Common.EnumService.GetDescription<Rc.Model.Resources.UOrderStatus>(dt.Rows[i]["UserOrder_Status"].ToString()),
