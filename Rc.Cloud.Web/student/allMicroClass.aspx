<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/student.Master" AutoEventWireup="true" CodeBehind="allMicroClass.aspx.cs" Inherits="Rc.Cloud.Web.student.allMicroClass" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="iframe-subnav">
        <ul class="subnav">
            ...
            <li><a href="allMicroClass.aspx" class="active">全部微课件</a></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSContent" runat="server">
    <script type="text/javascript">
        ...
        var loadData = function () {
            ...
            $.ajaxWebService("allMicroClass.aspx/GetResourceFolderListPage", JSON.stringify(dto), function (data) {
