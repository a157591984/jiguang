<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/student.Master" AutoEventWireup="true" CodeBehind="allTeachingPlan.aspx.cs" Inherits="Rc.Cloud.Web.student.allTeachingPlan" %>
                    ...
                    <div class="filter_row clearfix">
                        ...
                        <div class="row_item">
                            <ul ajax-name="resource_type">
                                ...
                                <li><a href='##' class='' ajax-value='3'>微课件</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
