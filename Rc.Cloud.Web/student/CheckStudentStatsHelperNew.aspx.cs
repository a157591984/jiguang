...
{
    public partial class CheckStudentStatsHelperNew : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (type == "1")//批改详情
            {
                ...
                {
                    link = string.Format("ohomeworkview_clientNew.aspx?ResourceToResourceFolder_Id={0}&HomeWork_ID={1}&StudentId={2}&Student_HomeWork_Id={3}"
                ...
                {
                    link = string.Format("oHomeWorkViewTTNew.aspx?ResourceToResourceFolder_Id={0}&HomeWork_ID={1}&StudentId={2}"
                                                    , ResourceToResourceFolder_Id
                                                    , HomeWork_ID
                                                    , StudentId);
                }
            ...
            {
                link = string.Format("../Evaluation/StudentAnalysisReportsNew2.aspx?ResourceToResourceFolder_Id={0}&HomeWork_ID={1}&StudentId={2}&Student_HomeWork_Id={3}"
                , ResourceToResourceFolder_Id
                , HomeWork_ID
                , StudentId
