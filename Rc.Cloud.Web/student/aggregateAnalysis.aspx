<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/student.Master" AutoEventWireup="true" CodeBehind="aggregateAnalysis.aspx.cs" Inherits="Rc.Cloud.Web.student.aggregateAnalysis" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="comprehensive_data_analysis">
            ...
            <div class="content">
                <div class="content_sidebar">
                    ...
                    <div class="mtree mtree-knowledge-hook ph" ajax-name="divKPList"></div>
                </div>
                <div class="content_main">
                    <ul class="nav nav-tabs mb">
                        <li class="active"><a href="##">综合分析</a></li>
                    ...
                    <table class="table table-bordered" data-name="tablesorter">
                        <thead>
                            <tr>
                                <th>知识点</th>
                                <th width="140">知识点掌握程度</th>
                                <th width="90">作业总数</th>
                                <th width="90">答对题</th>
                                <th width="100">答错题详情</th>
                            </tr>
                        </thead>
                        <tbody id="tbRes">
                        </tbody>
    ...
    {#foreach $T.list as record}
        <tr>
            ...
            <td>{$T.record.KPMastery}%</td>
            <td>{$T.record.HWCount}</td>
            <td>{$T.record.TQCount_Right}</td>
            <td class="opera">
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSContent" runat="server">
    <script type="text/javascript">
        ...
        function loadData() {
            ...
            $.ajaxWebService("aggregateAnalysis.aspx/GetDataList", JSON.stringify(dto), function (data) {
