<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/parent.Master" AutoEventWireup="true" CodeBehind="safeSetting.aspx.cs" Inherits="Rc.Cloud.Web.parent.safeSetting" %>
        ...
        $(function () {
            $("#btnConfirm").click(function () {
                ...
                if ($.trim($("#txtNewPass2").val()) == "") {
                    layer.msg("请输入重复密码", { time: 1000, icon: 2 });
                    return false;
                }
                if ($.trim($("#txtNewPass2").val()) != $.trim($("#txtNewPass").val())) {
                    layer.msg("两次输入的密码不一致", { time: 1000, icon: 2 });
                    return false;
                }
            });
        });
