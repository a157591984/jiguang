<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/parent.Master" AutoEventWireup="true" CodeBehind="subject.aspx.cs" Inherits="Rc.Cloud.Web.parent.subject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="header_subnav">
        <ul>
            ...
            <li><a href="subject.aspx?struserid=<%=struserid %>" class="active">学科排名</a></li>
    ...
    <div class="main_box">
        ...
        <div class="left_sidebar">
            ...
            <%--<dl>
                <dd><a href="javascript:void(0)" id="datetype1" value="<%=Rc.Cloud.Web.Common.PublicEnum.YearType %>">年度排名</a></dd>
                <dd><a href="javascript:void(0)" id="datetype2" value="<%=Rc.Cloud.Web.Common.PublicEnum.SemesterType %>">学期排名</a></dd>
                <dd><a href="javascript:void(0)" id="datetype3" value="<%=Rc.Cloud.Web.Common.PublicEnum.MonthlyType %>">月度排名</a></dd>
            </dl>--%>
        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSContent" runat="server">
    <script type="text/javascript">
        ...
        var loadData = function () {
            ...
            $.ajaxWebService("subject.aspx/GetStatTest_SubjectRListPage", JSON.stringify(dto), function (data) {
                ...
                if (json.err == "null") {
                    ...
                    $("#tbRes").html("<tr class='tr_con_002'><td colspan='4' align='center'>暂无数据</td></tr>");
