...
namespace Rc.Cloud.Web.Common
{
    ...
    /// 不使用模板页的普通页面
    /// </summary>
    public class FInitData : System.Web.UI.Page
    {
        ...
        { get; set; }
        public Model_F_User FloginUser
        {
            get
            {
        ...
        protected void Page_PreInit(object sender, EventArgs e)
        {
            ...
            FloginUser = Rc.Common.StrUtility.clsUtility.IsFPageFlag(this.Page) as Model_F_User;
            Rc.Cloud.Web.Common.pfunction.CheckUserPage(FloginUser);
        }
        /// <summary>
        /// 操作成功 
        /// </summary>
        ...
        {
            siteMap = new Rc.Cloud.BLL. BLL_SysModule().GetModule_PathBySetMapBySysCode(Module_Id, "1");
        }
        /// <summary>
        /// 导航
        /// </summary>
        ...
        {
            siteMapIds = new Rc.Cloud.BLL.BLL_SysModule().GetSetMapByCacheBySysCode(Module_Id, "2");
        }
