<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/sys.Master" AutoEventWireup="true" CodeBehind="ImportClassMember.aspx.cs" Inherits="Rc.Cloud.Web.Sys.ImportClassMember" %>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="form-inline search_bar mb">
                        ...
                        <a href="../Upload/Template/班级成员.xls" class="btn btn-default btn-sm">下载班级成员模板</a>
                    <span id="divHandel" runat="server">
                        <input type="button" class="btn btn-success btn-sm" onclick="showExcelData('good')" value='只显示验证通过' />
                        <input type="button" class="btn btn-danger btn-sm" onclick="showExcelData('bad')" value='只显示验证没通过' />
                        <input type="button" class="btn btn-primary btn-sm" onclick="showExcelData('all')" value='显示所有' />
                        <asp:Button ID="btnImpRight" runat="server" CssClass="btn btn-primary btn-sm" Text="导入验证通过班级成员"
                            OnClick="btnImpRight_Click" />
                        <%--<td><asp:Button ID="Button1" runat="server" CssClass="btn btn-default btn-sm" text="只导出验证没通过" /></td>--%>
                        <asp:Button ID="btnCancel" runat="server" CssClass="btn btn-warning btn-sm" Text="取消"
