...
{
    public partial class SpecialPoint : Rc.Cloud.Web.Common.InitPage
    {
...
order by t3.D_Order ", HeadDict_Id, SonDict_Id, Parent_Id);
        ...
        public static string GetDataList(string Name, string GradeTerm, string Subject, string Syllabus, string Test_Category, int PageIndex, int PageSize)
        {
            try
            {
                ...
                string strWhere = " Parent_Id='0' and  Data_Type='3' ";//考点
                ...
                DataTable dtAll = bll.GetList("Data_Type='3'").Tables[0];
        ...
        public static string GetSubDataList(string parentId, string parentIdStr)
        {
            try
            {
                ...
                DataTable dt = new DataTable();
                List<object> listReturn = new List<object>();
                string strWhere = " Parent_Id='" + parentId + "' and Data_Type='3' ";
