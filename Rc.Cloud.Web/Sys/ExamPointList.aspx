<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/sys.Master" AutoEventWireup="true" CodeBehind="ExamPointList.aspx.cs" Inherits="Rc.Cloud.Web.Sys.ExamPointList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSContent" runat="server">
    <script type="text/javascript">
            ...
            $("#btnAdd").click(function () {
                layer.ready(function () {
                    layer.open({
                        ...
                        fix: false,
                        area: ["450px", "540px"],
                        content: "ExamPointEdit.aspx?parentId=0&GradeTerm=" + $('[ajax-name="GradeTerm"] a[class="active"]').attr("ajax-value")
        ...
        var loadSubDict = function (hId, sId, pId, objContainer) {
            ...
            $.ajaxWebService("ExamPointList.aspx/GetSubDictList", JSON.stringify(dto), function (data) {
        ...
        var loadData = function () {
            ...
            $.ajaxWebService("ExamPointList.aspx/GetDataList", JSON.stringify(dto), function (data) {
        ...
        var loadSubData2 = function ($toggle) {
            if ($(_objTD).html() != undefined) {
                ...
                if ($toggle == "0") {//加载子级数据
                    ...
                    $.ajaxWebService("ExamPointList.aspx/GetSubDataList", JSON.stringify(dto), function (data) {
                        var json = $.parseJSON(data.d);
                        if (json.err == "null") {
            ...
            layer.ready(function () {
                layer.ready(function () {
                    layer.open({
                        ...
                        fix: false,
                        area: ["450px", "540px"],
                        content: "ExamPointEdit.aspx?GradeTerm=" + $('[ajax-name="GradeTerm"] a[class="active"]').attr("ajax-value")
                        + "&Subject=" + $('[ajax-name="Subject"] a[class="active"]').attr("ajax-value")
        ...
        function UpdateData(obj, kpId, parentId) {
            ...
            layer.ready(function () {
                layer.open({
                    ...
                    fix: false,
                    area: ["450px", "540px"],
                    content: "ExamPointEdit.aspx?kpId=" + kpId + "&parentId=" + parentId
                })
            });
        }
        ...
        function DeleteData(obj, kpId) {
            layer.ready(function () {
                layer.confirm("确定要删除吗？", { icon: 2, title: "删除提示" }, function () {
                    $.ajaxWebService("ExamPointList.aspx/DeleteData", "{S_TestingPoint_Id:'" + kpId + "',x:" + Math.random() + "}", function (data) {
                        if (data.d == "1") {
