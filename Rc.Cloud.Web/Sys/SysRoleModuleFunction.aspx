<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/sys.Master" AutoEventWireup="true"
    CodeBehind="SysRoleModuleFunction.aspx.cs" Inherits="Rc.HospitalConfigManage.Web.Sys.SysRoleModuleFunction" %>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="mt">
                    ...
                    <asp:Button runat="server" ID="btnSubmit" CssClass="btn btn-primary" Text="提交" OnClientClick='return setValue(); '
