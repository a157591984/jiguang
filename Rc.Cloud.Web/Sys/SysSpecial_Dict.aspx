<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/sys.Master" AutoEventWireup="true" CodeBehind="SysSpecial_Dict.aspx.cs" Inherits="Rc.Cloud.Web.Sys.SysSpecial_Dict" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function DeleteItemDesc(id) {
            ...
            function () {
                var exists;
                $.get("../Ajax/SysAjax.aspx", { key: "SysCommon_Dict1TempDelete", Aid: id, net4: Math.random() },
                function (data) {
                    if (data == "1") {
        ...
        function showPopCommon_Dict(id, handel) {
            var page = "SysCommon_DictAdd1.aspx?id=" + id;
            if (handel == "1") {//添加
