<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestAlipay.aspx.cs" Inherits="Rc.Cloud.Web.Payment.WebForm1" %>
...
：</dt>
                    ...
                    <dd>
                        <span class="new-btn-login-sp">
                            ...
                            <asp:Button runat="server" ID="btnDDD" Text="手动测试支付异步回调" OnClick="btnDDD_Click" />
                        </span></dd>
                </dl>
            </div>
            <div id="foot">
