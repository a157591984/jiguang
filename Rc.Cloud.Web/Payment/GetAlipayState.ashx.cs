...
{
    /// <summary>
    /// GetAlipayState 的摘要说明
    /// </summary>
    public class GetAlipayState : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                new Rc.Cloud.BLL.BLL_clsAuth().AddLogErrorFromBS(context.Request.Url.ToString(), string.Format("类：{0}，方法{1},错误信息：{2}", ex.TargetSite.DeclaringType.ToString(), ex.TargetSite.Name.ToString(), ex.Message));
