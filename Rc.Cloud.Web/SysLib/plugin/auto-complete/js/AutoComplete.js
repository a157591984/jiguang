...
function AutoCompleteUnderText(AutoCompleteObjText, AutoCompleteVectors) {
    ...
    var oHtopt = $("#" + AutoCompleteObjText).outerHeight();
    var oWidth = $("#" + AutoCompleteObjText).outerWidth();
    var oHleft = $("#" + AutoCompleteObjText).offset().left;
    var s_top;

    s_top = (oHtop + oHtopt);
    $("#" + AutoCompleteVectors).css({ "overflow": "hidden", "position": "fixed", "z-index": "1000", "left": oHleft, "width": oWidth, "top": s_top, "background-color": "White" });
