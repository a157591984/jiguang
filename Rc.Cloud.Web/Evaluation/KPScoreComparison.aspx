<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/TeacherStats.Master" AutoEventWireup="true" CodeBehind="KPScoreComparison.aspx.cs" Inherits="Rc.Cloud.Web.Evaluation.KPScoreComparison" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        var loadData = function () {
            ...
            $.ajaxWebService("KPScoreComparison.aspx/StatsClassHW_KP", JSON.stringify(dto), function (data) {
                if (data.d != "") {
                    if (data.d != "") {
                        var json = $.parseJSON(data.d);
                        $("#tb1").html(json.thead);
                        $("#tb2").html(json.tbody);
                        DataSour(json.StrKPNum, json.DateSour);
...
<asp:Content ID="Content2" ContentPlaceHolderID="Container" runat="server">
    <ul class="nav nav-tabs mb">
        ...
        <li class="active"><a href="KPScoreComparison.aspx?ResourceToResourceFolder_Id=<%=ResourceToResourceFolder_Id %>&HomeWork_ID=<%=HomeWork_ID %><%=StrTemp %>">知识点得分对比</a></li>
        <li class="pull-right">
