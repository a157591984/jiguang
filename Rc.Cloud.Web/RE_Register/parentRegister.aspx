<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="parentRegister.aspx.cs" Inherits="Rc.Cloud.Web.RE_Register.parentRegister" %>
...
<head runat="server">
    ...
    <title><%=Rc.Common.ConfigHelper.GetConfigString("WebSiteName") %>-家长注册</title>
        ...
        <div class="index_panel pt">
            ...
            <div class="register_panel form-horizontal">
                <div class="form-group">
                    <div class="col-xs-5 col-xs-offset-2">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a href="javascript:;">家长注册</a></li>
                        </ul>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-5">
                        <asp:TextBox ID="txt_password" CssClass="form-control" TextMode="Password" runat="server" ClientIDMode="Static"></asp:TextBox>
                    </div>
