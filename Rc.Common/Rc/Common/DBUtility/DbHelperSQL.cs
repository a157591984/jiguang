namespace Rc.Common.DBUtility
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        public static string GetValueByTableAndFiled(string tableName, string filedName, string Where)
        {
            ...
            object single = GetSingle(builder.ToString());
            if (single != null)
            {
        ...
        public static DataSet RunProcedure(string storedProcName, IDataParameter[] parameters, string tableName, out int rCount)
        {
            rCount = 0;
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
