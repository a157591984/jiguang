namespace Rc.DAL.Resources
{
    ...
    public class DAL_StatsTeacherClassHW_Hierarchy
    {
        public bool Add(Model_StatsTeacherClassHW_Hierarchy model)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("insert into StatsTeacherClassHW_Hierarchy(");
            builder.Append("StatsTeacherClassHW_HierarchyID,ResourceToResourceFolder_Id,Resource_Name,SchoolID,SchoolName,Gradeid,GradeName,ClassID,ClassName,SubjectID,SubjectName,TeacherID,TeacherName,Hierarchy,HierarchyCount,HierarchyCountRate,ClassAllCount,CreateTime)");
            builder.Append(" values (");
            builder.Append("@StatsTeacherClassHW_HierarchyID,@ResourceToResourceFolder_Id,@Resource_Name,@SchoolID,@SchoolName,@Gradeid,@GradeName,@ClassID,@ClassName,@SubjectID,@SubjectName,@TeacherID,@TeacherName,@Hierarchy,@HierarchyCount,@HierarchyCountRate,@ClassAllCount,@CreateTime)");
            SqlParameter[] cmdParms = new SqlParameter[] { 
                new SqlParameter("@StatsTeacherClassHW_HierarchyID", SqlDbType.Char, 0x24), new SqlParameter("@ResourceToResourceFolder_Id", SqlDbType.Char, 0x24), new SqlParameter("@Resource_Name", SqlDbType.NVarChar, 250), new SqlParameter("@SchoolID", SqlDbType.VarChar, 10), new SqlParameter("@SchoolName", SqlDbType.NVarChar, 250), new SqlParameter("@Gradeid", SqlDbType.VarChar, 10), new SqlParameter("@GradeName", SqlDbType.NVarChar, 250), new SqlParameter("@ClassID", SqlDbType.VarChar, 10), new SqlParameter("@ClassName", SqlDbType.NVarChar, 250), new SqlParameter("@SubjectID", SqlDbType.Char, 0x24), new SqlParameter("@SubjectName", SqlDbType.NVarChar, 250), new SqlParameter("@TeacherID", SqlDbType.Char, 0x24), new SqlParameter("@TeacherName", SqlDbType.NVarChar, 250), new SqlParameter("@Hierarchy", SqlDbType.Decimal, 5), new SqlParameter("@HierarchyCount", SqlDbType.Decimal, 5), new SqlParameter("@HierarchyCountRate", SqlDbType.Decimal, 5), 
                new SqlParameter("@ClassAllCount", SqlDbType.Decimal, 5), new SqlParameter("@CreateTime", SqlDbType.DateTime)
             };
            cmdParms[0].Value = model.StatsTeacherClassHW_HierarchyID;
        ...
        public Model_StatsTeacherClassHW_Hierarchy DataRowToModel(DataRow row)
        {
            Model_StatsTeacherClassHW_Hierarchy hierarchy = new Model_StatsTeacherClassHW_Hierarchy();
            if (row != null)
            {
                if (row["StatsTeacherClassHW_HierarchyID"] != null)
                {
                    hierarchy.StatsTeacherClassHW_HierarchyID = row["StatsTeacherClassHW_HierarchyID"].ToString();
                }
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("delete from StatsTeacherClassHW_Hierarchy ");
            builder.Append(" where StatsTeacherClassHW_HierarchyID=@StatsTeacherClassHW_HierarchyID ");
            SqlParameter[] cmdParms = new SqlParameter[] { new SqlParameter("@StatsTeacherClassHW_HierarchyID", SqlDbType.Char, 0x24) };
            cmdParms[0].Value = StatsTeacherClassHW_HierarchyID;
            return (DbHelperSQL.ExecuteSql(builder.ToString(), cmdParms) > 0);
        }
        ...
        public bool DeleteList(string StatsTeacherClassHW_HierarchyIDlist)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("delete from StatsTeacherClassHW_Hierarchy ");
            builder.Append(" where StatsTeacherClassHW_HierarchyID in (" + StatsTeacherClassHW_HierarchyIDlist + ")  ");
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select count(1) from StatsTeacherClassHW_Hierarchy");
            builder.Append(" where StatsTeacherClassHW_HierarchyID=@StatsTeacherClassHW_HierarchyID ");
            SqlParameter[] cmdParms = new SqlParameter[] { new SqlParameter("@StatsTeacherClassHW_HierarchyID", SqlDbType.Char, 0x24) };
            cmdParms[0].Value = StatsTeacherClassHW_HierarchyID;
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select StatsTeacherClassHW_HierarchyID,ResourceToResourceFolder_Id,Resource_Name,SchoolID,SchoolName,Gradeid,GradeName,ClassID,ClassName,SubjectID,SubjectName,TeacherID,TeacherName,Hierarchy,HierarchyCount,HierarchyCountRate,ClassAllCount,CreateTime ");
            builder.Append(" FROM StatsTeacherClassHW_Hierarchy ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            {
                builder.Append("order by T.StatsTeacherClassHW_HierarchyID desc");
            }
            builder.Append(")AS Row, T.*  from StatsTeacherClassHW_Hierarchy T ");
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select  top 1 StatsTeacherClassHW_HierarchyID,ResourceToResourceFolder_Id,Resource_Name,SchoolID,SchoolName,Gradeid,GradeName,ClassID,ClassName,SubjectID,SubjectName,TeacherID,TeacherName,Hierarchy,HierarchyCount,HierarchyCountRate,ClassAllCount,CreateTime from StatsTeacherClassHW_Hierarchy ");
            builder.Append(" where StatsTeacherClassHW_HierarchyID=@StatsTeacherClassHW_HierarchyID ");
            SqlParameter[] cmdParms = new SqlParameter[] { new SqlParameter("@StatsTeacherClassHW_HierarchyID", SqlDbType.Char, 0x24) };
            cmdParms[0].Value = StatsTeacherClassHW_HierarchyID;
            new Model_StatsTeacherClassHW_Hierarchy();
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("update StatsTeacherClassHW_Hierarchy set ");
            ...
            SqlParameter[] cmdParms = new SqlParameter[] { 
                ...
                new SqlParameter("@CreateTime", SqlDbType.DateTime), new SqlParameter("@StatsTeacherClassHW_HierarchyID", SqlDbType.Char, 0x24)
             };
            ...
            cmdParms[0x11].Value = model.StatsTeacherClassHW_HierarchyID;
            return (DbHelperSQL.ExecuteSql(builder.ToString(), cmdParms) > 0);
        }
    }
}
