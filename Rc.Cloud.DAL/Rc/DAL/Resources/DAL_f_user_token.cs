namespace Rc.DAL.Resources
{
    ...
    public class DAL_f_user_token
    {
        ...
        public Model_f_user_token DataRowToModel(DataRow row)
        {
            Model_f_user_token _token = new Model_f_user_token();
            if (row != null)
            {
                if (row["user_id"] != null)
                {
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("delete from f_user_token ");
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select count(1) from f_user_token");
            builder.Append(" where user_id=@user_id and product_type=@product_type ");
            SqlParameter[] cmdParms = new SqlParameter[] { new SqlParameter("@user_id", SqlDbType.Char, 0x24), new SqlParameter("@product_type", SqlDbType.VarChar, 50) };
            cmdParms[0].Value = user_id;
            cmdParms[1].Value = product_type;
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            builder.Append(" FROM f_user_token ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            builder.Append(")AS Row, T.*  from f_user_token T ");
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select  top 1 user_id,product_type,token,token_time,login_time,login_ip from f_user_token ");
            builder.Append(" where user_id=@user_id and product_type=@product_type ");
            SqlParameter[] cmdParms = new SqlParameter[] { new SqlParameter("@user_id", SqlDbType.Char, 0x24), new SqlParameter("@product_type", SqlDbType.VarChar, 50) };
            cmdParms[0].Value = user_id;
            cmdParms[1].Value = product_type;
            new Model_f_user_token();
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("update f_user_token set ");
