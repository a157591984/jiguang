namespace Rc.DAL.Resources
{
    ...
    public class DAL_StatsTeacherHW_ScoreLevel
    {
        public bool Add(Model_StatsTeacherHW_ScoreLevel model)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("insert into StatsTeacherHW_ScoreLevel(");
            builder.Append("StatsTeacherHW_ScoreLevelID,ResourceToResourceFolder_Id,Resource_Name,SchoolID,SchoolName,Gradeid,GradeName,SubjectID,SubjectName,TeacherID,TeacherName,HWScoreLevelLeft,HWScoreLevelRight,HWScoreLevelCount,HWScoreLevelCountRate,HWScore,TeacherAllCount,CorrectedCount,HWScoreLevelDictID,HWScoreLevelName,HWScoreLevelRateLeft,HWScoreLevelRateRight,AddedValue,CreateTime)");
            builder.Append(" values (");
            builder.Append("@StatsTeacherHW_ScoreLevelID,@ResourceToResourceFolder_Id,@Resource_Name,@SchoolID,@SchoolName,@Gradeid,@GradeName,@SubjectID,@SubjectName,@TeacherID,@TeacherName,@HWScoreLevelLeft,@HWScoreLevelRight,@HWScoreLevelCount,@HWScoreLevelCountRate,@HWScore,@TeacherAllCount,@CorrectedCount,@HWScoreLevelDictID,@HWScoreLevelName,@HWScoreLevelRateLeft,@HWScoreLevelRateRight,@AddedValue,@CreateTime)");
            SqlParameter[] cmdParms = new SqlParameter[] { 
                new SqlParameter("@StatsTeacherHW_ScoreLevelID", SqlDbType.Char, 0x24), new SqlParameter("@ResourceToResourceFolder_Id", SqlDbType.Char, 0x24), new SqlParameter("@Resource_Name", SqlDbType.NVarChar, 250), new SqlParameter("@SchoolID", SqlDbType.VarChar, 10), new SqlParameter("@SchoolName", SqlDbType.NVarChar, 250), new SqlParameter("@Gradeid", SqlDbType.VarChar, 10), new SqlParameter("@GradeName", SqlDbType.NVarChar, 250), new SqlParameter("@SubjectID", SqlDbType.Char, 0x24), new SqlParameter("@SubjectName", SqlDbType.NVarChar, 250), new SqlParameter("@TeacherID", SqlDbType.Char, 0x24), new SqlParameter("@TeacherName", SqlDbType.NVarChar, 250), new SqlParameter("@HWScoreLevelLeft", SqlDbType.Decimal, 5), new SqlParameter("@HWScoreLevelRight", SqlDbType.Decimal, 5), new SqlParameter("@HWScoreLevelCount", SqlDbType.Decimal, 5), new SqlParameter("@HWScoreLevelCountRate", SqlDbType.Decimal, 5), new SqlParameter("@HWScore", SqlDbType.Decimal, 5), 
                new SqlParameter("@TeacherAllCount", SqlDbType.Decimal, 5), new SqlParameter("@CorrectedCount", SqlDbType.Decimal, 5), new SqlParameter("@HWScoreLevelDictID", SqlDbType.Char, 0x24), new SqlParameter("@HWScoreLevelName", SqlDbType.NVarChar, 50), new SqlParameter("@HWScoreLevelRateLeft", SqlDbType.Decimal, 5), new SqlParameter("@HWScoreLevelRateRight", SqlDbType.Decimal, 5), new SqlParameter("@AddedValue", SqlDbType.Decimal, 5), new SqlParameter("@CreateTime", SqlDbType.DateTime)
             };
            cmdParms[0].Value = model.StatsTeacherHW_ScoreLevelID;
            ...
            cmdParms[11].Value = model.HWScoreLevelLeft;
            cmdParms[12].Value = model.HWScoreLevelRight;
            cmdParms[13].Value = model.HWScoreLevelCount;
            cmdParms[14].Value = model.HWScoreLevelCountRate;
            cmdParms[15].Value = model.HWScore;
            cmdParms[0x10].Value = model.TeacherAllCount;
            cmdParms[0x11].Value = model.CorrectedCount;
            cmdParms[0x12].Value = model.HWScoreLevelDictID;
            cmdParms[0x13].Value = model.HWScoreLevelName;
            cmdParms[20].Value = model.HWScoreLevelRateLeft;
            cmdParms[0x15].Value = model.HWScoreLevelRateRight;
            cmdParms[0x16].Value = model.AddedValue;
            cmdParms[0x17].Value = model.CreateTime;
            return (DbHelperSQL.ExecuteSql(builder.ToString(), cmdParms) > 0);
        }

        public Model_StatsTeacherHW_ScoreLevel DataRowToModel(DataRow row)
        {
            Model_StatsTeacherHW_ScoreLevel level = new Model_StatsTeacherHW_ScoreLevel();
            if (row != null)
            {
                if (row["StatsTeacherHW_ScoreLevelID"] != null)
                {
                    level.StatsTeacherHW_ScoreLevelID = row["StatsTeacherHW_ScoreLevelID"].ToString();
                }
                ...
                {
                    level.TeacherAllCount = new decimal?(decimal.Parse(row["TeacherAllCount"].ToString()));
                }
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("delete from StatsTeacherHW_ScoreLevel ");
            builder.Append(" where StatsTeacherHW_ScoreLevelID=@StatsTeacherHW_ScoreLevelID ");
            SqlParameter[] cmdParms = new SqlParameter[] { new SqlParameter("@StatsTeacherHW_ScoreLevelID", SqlDbType.Char, 0x24) };
            cmdParms[0].Value = StatsTeacherHW_ScoreLevelID;
            return (DbHelperSQL.ExecuteSql(builder.ToString(), cmdParms) > 0);
        }
        ...
        public bool DeleteList(string StatsTeacherHW_ScoreLevelIDlist)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("delete from StatsTeacherHW_ScoreLevel ");
            builder.Append(" where StatsTeacherHW_ScoreLevelID in (" + StatsTeacherHW_ScoreLevelIDlist + ")  ");
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select count(1) from StatsTeacherHW_ScoreLevel");
            builder.Append(" where StatsTeacherHW_ScoreLevelID=@StatsTeacherHW_ScoreLevelID ");
            SqlParameter[] cmdParms = new SqlParameter[] { new SqlParameter("@StatsTeacherHW_ScoreLevelID", SqlDbType.Char, 0x24) };
            cmdParms[0].Value = StatsTeacherHW_ScoreLevelID;
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select StatsTeacherHW_ScoreLevelID,ResourceToResourceFolder_Id,Resource_Name,SchoolID,SchoolName,Gradeid,GradeName,SubjectID,SubjectName,TeacherID,TeacherName,HWScoreLevelLeft,HWScoreLevelRight,HWScoreLevelCount,HWScoreLevelCountRate,HWScore,TeacherAllCount,CorrectedCount,HWScoreLevelDictID,HWScoreLevelName,HWScoreLevelRateLeft,HWScoreLevelRateRight,AddedValue,CreateTime ");
            builder.Append(" FROM StatsTeacherHW_ScoreLevel ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            {
                builder.Append("order by T.StatsTeacherHW_ScoreLevelID desc");
            }
            builder.Append(")AS Row, T.*  from StatsTeacherHW_ScoreLevel T ");
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select  top 1 StatsTeacherHW_ScoreLevelID,ResourceToResourceFolder_Id,Resource_Name,SchoolID,SchoolName,Gradeid,GradeName,SubjectID,SubjectName,TeacherID,TeacherName,HWScoreLevelLeft,HWScoreLevelRight,HWScoreLevelCount,HWScoreLevelCountRate,HWScore,TeacherAllCount,CorrectedCount,HWScoreLevelDictID,HWScoreLevelName,HWScoreLevelRateLeft,HWScoreLevelRateRight,AddedValue,CreateTime from StatsTeacherHW_ScoreLevel ");
            builder.Append(" where StatsTeacherHW_ScoreLevelID=@StatsTeacherHW_ScoreLevelID ");
            SqlParameter[] cmdParms = new SqlParameter[] { new SqlParameter("@StatsTeacherHW_ScoreLevelID", SqlDbType.Char, 0x24) };
            cmdParms[0].Value = StatsTeacherHW_ScoreLevelID;
            new Model_StatsTeacherHW_ScoreLevel();
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("update StatsTeacherHW_ScoreLevel set ");
            ...
            builder.Append(" where StatsTeacherHW_ScoreLevelID=@StatsTeacherHW_ScoreLevelID ");
            SqlParameter[] cmdParms = new SqlParameter[] { 
                new SqlParameter("@ResourceToResourceFolder_Id", SqlDbType.Char, 0x24), new SqlParameter("@Resource_Name", SqlDbType.NVarChar, 250), new SqlParameter("@SchoolID", SqlDbType.VarChar, 10), new SqlParameter("@SchoolName", SqlDbType.NVarChar, 250), new SqlParameter("@Gradeid", SqlDbType.VarChar, 10), new SqlParameter("@GradeName", SqlDbType.NVarChar, 250), new SqlParameter("@SubjectID", SqlDbType.Char, 0x24), new SqlParameter("@SubjectName", SqlDbType.NVarChar, 250), new SqlParameter("@TeacherID", SqlDbType.Char, 0x24), new SqlParameter("@TeacherName", SqlDbType.NVarChar, 250), new SqlParameter("@HWScoreLevelLeft", SqlDbType.Decimal, 5), new SqlParameter("@HWScoreLevelRight", SqlDbType.Decimal, 5), new SqlParameter("@HWScoreLevelCount", SqlDbType.Decimal, 5), new SqlParameter("@HWScoreLevelCountRate", SqlDbType.Decimal, 5), new SqlParameter("@HWScore", SqlDbType.Decimal, 5), new SqlParameter("@TeacherAllCount", SqlDbType.Decimal, 5), 
                new SqlParameter("@CorrectedCount", SqlDbType.Decimal, 5), new SqlParameter("@HWScoreLevelDictID", SqlDbType.Char, 0x24), new SqlParameter("@HWScoreLevelName", SqlDbType.NVarChar, 50), new SqlParameter("@HWScoreLevelRateLeft", SqlDbType.Decimal, 5), new SqlParameter("@HWScoreLevelRateRight", SqlDbType.Decimal, 5), new SqlParameter("@AddedValue", SqlDbType.Decimal, 5), new SqlParameter("@CreateTime", SqlDbType.DateTime), new SqlParameter("@StatsTeacherHW_ScoreLevelID", SqlDbType.Char, 0x24)
             };
            ...
            cmdParms[10].Value = model.HWScoreLevelLeft;
            cmdParms[11].Value = model.HWScoreLevelRight;
            cmdParms[12].Value = model.HWScoreLevelCount;
            cmdParms[13].Value = model.HWScoreLevelCountRate;
            cmdParms[14].Value = model.HWScore;
            cmdParms[15].Value = model.TeacherAllCount;
            cmdParms[0x10].Value = model.CorrectedCount;
            cmdParms[0x11].Value = model.HWScoreLevelDictID;
            cmdParms[0x12].Value = model.HWScoreLevelName;
            cmdParms[0x13].Value = model.HWScoreLevelRateLeft;
            cmdParms[20].Value = model.HWScoreLevelRateRight;
            cmdParms[0x15].Value = model.AddedValue;
            cmdParms[0x16].Value = model.CreateTime;
            cmdParms[0x17].Value = model.StatsTeacherHW_ScoreLevelID;
            return (DbHelperSQL.ExecuteSql(builder.ToString(), cmdParms) > 0);
        }
    }
}
