namespace Rc.DAL.Resources
{
    ...
    public class DAL_Student_Mutual_Correct
    {
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("delete from Student_Mutual_Correct ");
            builder.Append(" where Student_Mutual_Correct_Id=@Student_Mutual_Correct_Id ");
            SqlParameter[] cmdParms = new SqlParameter[] { new SqlParameter("@Student_Mutual_Correct_Id", SqlDbType.Char, 0x24) };
            cmdParms[0].Value = Student_Mutual_Correct_Id;
            return (DbHelperSQL.ExecuteSql(builder.ToString(), cmdParms) > 0);
        }
        ...
        public bool DeleteList(string Student_Mutual_Correct_Idlist)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("delete from Student_Mutual_Correct ");
            builder.Append(" where Student_Mutual_Correct_Id in (" + Student_Mutual_Correct_Idlist + ")  ");
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select count(1) from Student_Mutual_Correct");
            builder.Append(" where Student_Mutual_Correct_Id=@Student_Mutual_Correct_Id ");
            SqlParameter[] cmdParms = new SqlParameter[] { new SqlParameter("@Student_Mutual_Correct_Id", SqlDbType.Char, 0x24) };
            cmdParms[0].Value = Student_Mutual_Correct_Id;
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select Student_Mutual_Correct_Id,Correct_Guid,HomeWork_Id,Student_Id,CreateTime,Remark ");
            builder.Append(" FROM Student_Mutual_Correct ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            {
                builder.Append("order by T.Student_Mutual_Correct_Id desc");
            }
            builder.Append(")AS Row, T.*  from Student_Mutual_Correct T ");
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select  top 1 Student_Mutual_Correct_Id,Correct_Guid,HomeWork_Id,Student_Id,CreateTime,Remark from Student_Mutual_Correct ");
            builder.Append(" where Student_Mutual_Correct_Id=@Student_Mutual_Correct_Id ");
            SqlParameter[] cmdParms = new SqlParameter[] { new SqlParameter("@Student_Mutual_Correct_Id", SqlDbType.Char, 0x24) };
            cmdParms[0].Value = Student_Mutual_Correct_Id;
            new Model_Student_Mutual_Correct();
