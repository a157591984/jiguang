namespace Rc.BLL.Resources
{
    ...
    public class BLL_Student_HomeWork_Correct
    {
        private readonly DAL_Student_HomeWork_Correct dal = new DAL_Student_HomeWork_Correct();
        ...
        public Model_Student_HomeWork_Correct GetModelByCache(string Student_HomeWork_Id)
        {
            string cacheKey = "Model_Student_HomeWork_CorrectModel-" + Student_HomeWork_Id;
            ...
            return (Model_Student_HomeWork_Correct) cache;
        }

        public List<Model_Student_HomeWork_Correct> GetModelList(string strWhere)
        {
