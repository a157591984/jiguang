namespace Rc.BLL.Resources
{
    ...
    public class BLL_SystemLog
    {
        ...
        public List<Model_SystemLog> DataTableToList(DataTable dt)
        {
            ...
            if (count > 0)
            {
                ...
                {
                    Model_SystemLog item = this.dal.DataRowToModel(dt.Rows[i]);
                    if (item != null)
                    {
                        list.Add(item);
                    }
        ...
        public Model_SystemLog GetModelByCache()
        {
            string cacheKey = "Model_SystemLogModel-";
            ...
            return (Model_SystemLog) cache;
        }

        public List<Model_SystemLog> GetModelList(string strWhere)
        {
