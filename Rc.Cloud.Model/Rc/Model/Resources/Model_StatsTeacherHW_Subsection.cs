namespace Rc.Model.Resources
{
    ...
    [Serializable]
    public class Model_StatsTeacherHW_Subsection
    {
        ...
        private string _statsteacherhw_subsectionid;
        private string _subjectid;
        private string _subjectname;
        private decimal? _subsectioncount;
        private string _subsectionname;
        private decimal? _teacherallcount;
        ...
        public string StatsTeacherHW_SubsectionID
        {
            get
            {
                return this._statsteacherhw_subsectionid;
            }
            set
            {
                this._statsteacherhw_subsectionid = value;
            }
        }
        ...
        public decimal? TeacherAllCount
        {
            get
            {
                return this._teacherallcount;
            }
            set
            {
                this._teacherallcount = value;
            }
        }
